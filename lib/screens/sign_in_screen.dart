              ...
              child: Column(
                ...
                children: [
                  Column(
                    children: [
                      Container(
                        margin: EdgeInsets.only(top: MediaQuery.of(context).size.height * 0.10, bottom: MediaQuery.of(context).size.height * 0.06),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 30),
                            IconTextInput(controller: emailController, hint: 'Email', icon: 'email', obscureText: false),
                            SizedBox(height: 10),
                            IconTextInput(controller: passwordController, hint: 'Password', icon: 'password', obscureText: true),
                            SizedBox(height: 20),
                          ],
                        ),
                      ),
